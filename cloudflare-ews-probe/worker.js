...
export default {
  async fetch(request, env) {
    ...
    try {
      ...
      if (url.pathname === '/api/health') return json({ ok: true, version: 'v1.5.0beta', protocol: 'Exchange ActiveSync 14.1', login: `${DOMAIN}\\kullanici`, folder: TARGET_FOLDER_PATH.join('\\') });
